...
export default function ResultsSection() {
  return (
    <section className="min-h-screen w-full py-20 px-6 bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
        ...
        {/* ---------------------------------------N---------------------------------------------------*/}
        {/* ---------------------------------------N---------------------------------------------------*/}
        <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-2xl border border-gray-700 
          ...
          <button className="mt-4 px-4 py-2 rounded-lg bg-cyan-500 hover:bg-cyan-600 transition">
            Découvrir
          </button>
        </div>
        ...
        <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-2xl border border-gray-700
          ...
          <button className="mt-4 px-4 py-2 rounded-lg bg-green-500 hover:bg-green-600 transition">
            Accéder
          </button>
        </div>
